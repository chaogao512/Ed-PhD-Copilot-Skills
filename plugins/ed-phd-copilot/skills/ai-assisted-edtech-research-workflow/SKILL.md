---
name: ai-assisted-edtech-research-workflow
description: >-
  Guides responsible AI-assisted research workflows for education technology, education informatization governance, educational leadership and management, doctoral research, literature review, coding, figure design, writing, and pre-submission revision. Use when the user asks how to use AI in EdTech research, plan AI-assisted writing, divide human-AI responsibilities, avoid academic misconduct, or verify AI-generated outputs.
---
...
- Read `references/venue-disclosure-templates.md` when preparing Chinese journal, doctoral defense, international journal or ethics-review disclosure wording.
...
1. Work-block classification
2. Human-AI division of labor
3. Recommended AI workflow
4. Verification checklist
5. Red-line risks
6. AI disclosure and confidentiality note when relevant
