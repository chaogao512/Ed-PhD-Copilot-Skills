...
> 本文为原始分享记录，转载自 [Supervisor-Skills](https://github.com/HKUSTDial/Supervisor-Skills) (CC BY-NC-SA 4.0)。部分案例出自计算机科学领域（Text-to-SQL、Agent 系统等），但其方法论（Vibe Coding/Figure/Writing 的心法与技法、AI 使用边界）适用于所有研究领域，包括教育技术研究。
