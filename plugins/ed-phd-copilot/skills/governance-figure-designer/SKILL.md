---
name: governance-figure-designer
description: >-
  Designs figures for education informatization governance, smart campus architecture, education data governance, AI governance, human-AI collaboration, mixed-methods evidence chains, and multi-actor education systems. Use when the user asks how to draw a system diagram, governance mechanism figure, framework figure, model figure, indicator system figure, evidence chain figure, or audit an EdTech manuscript figure.
---
...
1. Figure type
2. Recommended paradigm
3. Layout sketch
4. Element and label list
5. Arrow and relation rules
6. Caption draft
7. Quality audit and revision suggestions
