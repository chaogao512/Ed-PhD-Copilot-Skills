---
name: mixed-methods-evidence-template
description: >-
  Designs mixed-methods evidence chains for education technology, education informatization governance, indicator systems, evaluation models, smart campus interventions, teacher digital competence studies, and human-AI collaboration research. Use when planning Delphi studies, questionnaires, interviews, quasi-experiments, log-data analysis, validity checks, triangulation, or evidence alignment for EdTech manuscripts.
---
...
0. Select audit depth. Use `Light` for early idea exploration, `Standard` for proposal or manuscript planning, and `Strict` for pre-submission, defense or grant review.
...
|---|---|---|
| Light | User is exploring a topic or comparing rough designs | Top 3 evidence gaps and a feasible next data step |
| Standard | User is planning a proposal, chapter or manuscript | Full claim-evidence table, method route and claim boundaries |
| Strict | User is preparing submission, defense or funding review | Reporting-standard gates, ethics/data-governance audit and claim rewrites |
...
1. Research questions and claim types
2. Audit depth
3. Evidence alignment table
4. Indicator construction plan if applicable
5. Quantitative design
6. Qualitative design
7. Triangulation matrix
8. Ethics and data governance checklist
9. Claims that must be weakened or reframed
